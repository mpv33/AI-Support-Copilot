import { formatTokenCount, estimateReplyTokens } from '../ai/llm'
...
export function formatMessageMeta({ contextUsage, replyContent, agentSteps, retrievalMode, chatModel }) {
  ...
  if (!contextTokens && !replyTokens && !agentSteps?.length && !chatModel) return null
